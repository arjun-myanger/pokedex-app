      ...
      <div className={`container mx-auto px-4 py-8 transition-all duration-300 ${selectedPokemon ? 'blur-sm' : ''}`}>
        ...
        <header className="text-center mb-8">
          <h1 className="text-5xl font-bold text-gray-800 dark:text-white mb-2">
            Poké<span className="text-blue-600 dark:text-blue-400">dex</span>
          </h1>
          ...
          <Link 
            href="/team-builder"
            className="inline-flex items-center bg-blue-600 hover:bg-blue-700 dark:bg-blue-700 dark:hover:bg-blue-600 text-white px-6 py-3 rounded-lg transition-colors font-medium"
          >
        ...
        <footer className="text-center mt-12 py-8 text-gray-500 dark:text-gray-400">
          <p>Data provided by <a href="https://pokeapi.co" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:underline">PokeAPI</a></p>
        </footer>
      </div>
